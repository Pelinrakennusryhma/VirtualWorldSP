	...
	public sealed class PropertyDefinition : PropertyReference, IMemberDefinition, IConstantProvider
	{
		...
		public override Collection<ParameterDefinition> Parameters
		{
			get
			{
				...
				if (get_method != null)
					return FishNetParameters(get_method, 0);

				if (set_method != null)
					return FishNetParameters(set_method, 1);

				return new Collection<ParameterDefinition>();
			}
		}

		static Collection<ParameterDefinition> FishNetParameters(MethodDefinition method, int bound)
		{
